...
import Auth0Context, { Auth0ContextInterface, RedirectLoginOptions } from './auth0-context';
 ...
 */
const withAuthenticationRequired = <P extends object>(Component: ComponentType<P>, options: WithAuthenticationRequiredOptions = {}): FC<P> =>
    function WithAuthenticationRequired(props: P): React.JSX.Element {
        const { returnTo = defaultReturnTo, onRedirecting = defaultOnRedirecting, onBeforeAuthentication = defaultOnBeforeAuthentication, loginOptions, context = Auth0Context } = options;

        const { isAuthenticated, isLoading, loginWithRedirect } = useAuth0(context);
