 ...
 */
const withAuth0 = <P extends WithAuth0Props>(Component: ComponentType<P>, context = Auth0Context): ComponentType<Omit<P, keyof WithAuth0Props>> =>
    function WithAuth(props): React.JSX.Element {
        return <context.Consumer>{(auth: Auth0ContextInterface): React.JSX.Element => <Component {...(props as P)} auth0={auth} />}</context.Consumer>;
    };
