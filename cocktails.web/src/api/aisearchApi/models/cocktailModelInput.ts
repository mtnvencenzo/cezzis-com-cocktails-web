 ...
 * 
 * @export
 * @interface CocktailModelInput
 */
export interface CocktailModelInput {
    /**
...
/**
 * Check if a given object implements the CocktailModelInput interface.
 */
export function instanceOfCocktailModelInput(value: object): value is CocktailModelInput {
...
export function CocktailModelInputFromJSON(json: any): CocktailModelInput {
    return CocktailModelInputFromJSONTyped(json, false);
}

export function CocktailModelInputFromJSONTyped(json: any, ignoreDiscriminator: boolean): CocktailModelInput {
    if (json == null) {
        return json;
    }
    return {
...
export function CocktailModelInputToJSON(json: any): CocktailModelInput {
    return CocktailModelInputToJSONTyped(json, false);
}

export function CocktailModelInputToJSONTyped(value?: CocktailModelInput | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
