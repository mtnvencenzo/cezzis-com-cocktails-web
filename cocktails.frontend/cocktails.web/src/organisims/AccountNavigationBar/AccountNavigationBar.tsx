...
import { resetPassword } from '../../utils/authConfig';
        ...
        <Box>
            <Card variant='outlined' sx={{ borderRadius: '10px' }}>
                <CardContent>
                    ...
                    <ProfileSettingItemLink icon={<SecurityIcon />} text='Change Password' testId='p-settings-password' navigatePath='/account/profile-center#' onClick={() => resetPassword()} />
