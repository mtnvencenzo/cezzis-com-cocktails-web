...
public class GlasswareTypeModelConverter : EnumTypeConverter<GlasswareType, GlasswareTypeModel> { }

/// <summary>
/// 
/// </summary>
[TypeConverter(typeof(GlasswareTypeModelConverter))]
public enum GlasswareTypeModel
{
